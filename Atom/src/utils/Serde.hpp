...
NLOHMANN_JSON_SERIALIZE_ENUM(AtomScancode, {
	REGISTER_STRING(ATOM_SCANCODE_E)
	REGISTER_STRING(ATOM_SCANCODE_Q)
	REGISTER_STRING(ATOM_SCANCODE_G)
	REGISTER_STRING(ATOM_SCANCODE_H)
	REGISTER_STRING(ATOM_SCANCODE_NEXT_LEVEL)
	REGISTER_STRING(ATOM_SCANCODE_PREV_LEVEL)
